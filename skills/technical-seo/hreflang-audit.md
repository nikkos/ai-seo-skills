...
- A list of URLs with their current hreflang annotations (paste as table, CSV, or raw HTML <link> tags)
- Optionally: the site's CMS, the languages/regions targeted, and current implementation method

Output Instructions:
Once the hreflang data is provided, deliver the full audit with the correction table, severity labels, and implementation method recommendation.
